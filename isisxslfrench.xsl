...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
    ...
    <xsl:template match="explodev">
        ...
        <xsl:element name="DIV">
            ...
            -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;VUES &#201;CLAT&#201;ES</FONT>
                <BR/>
            </P>
            <xsl:apply-templates/>
        </xsl:element>
    ...
    <xsl:template match="sstools">
        ...
        <xsl:element name="DIV">
            ...
            <!-- <xsl:attribute name="STYLE">width:520px;text-align:left;z-index:0;border:1px solid gray;</xsl:attribute> -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;OUTILS SP&#201;CIAUX</FONT>
                <BR/>
            </P>
            <xsl:apply-templates/>
        </xsl:element>
    ...
    <xsl:template match="torque">
        ...
        <xsl:element name="DIV">
            ...
            -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;COUPLE</FONT>
                <BR/>
            </P>
            <xsl:apply-templates/>
        </xsl:element>
    ...
    <xsl:template match="warning">
        <xsl:element name="DIV">
            <xsl:attribute name="STYLE">text-align:left;z-index:0;border:1px solid gray;</xsl:attribute>
            <!--  <xsl:attribute name="STYLE">width:520px;text-align:left;z-index:0;border:1px solid gray;</xsl:attribute> -->
            <P STYLE="border:thin solid black;background-color:red;margin-right:50%;font-size:12pt;font-weight:bold;color:#FFFFFF;">
    ...
    <xsl:template match="apply">
        ...
        <P STYLE="background-color:#EEEEEE;text-align:left">
            <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;APPLIES &#192;
                <!-- <P STYLE="background-color:#EEEEEE;width:520px;text-align:left"><FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;APPLIES &#192; -->
    ...
    <xsl:template match="subject">
        ...
        <xsl:element name="DIV">
            ...
            <P STYLE="background-color:#EEEEEE;">
                ...
                <BR/>
                <!-- <P STYLE="background-color:#EEEEEE;"><FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;width:520px;text-align:left">&#160;OBJET </FONT><BR/> -->
                <!--
                <xsl:value-of/>
                -->
                <xsl:apply-templates/>
    ...
    <xsl:template match="wtsdescrip">
        ...
        <xsl:element name="DIV">
            ...
            <P STYLE="background-color:black;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:#FFFFFF;background-color:black;">&#160;WTS
                    DESCRIPTION
                    <BR/>
                    <xsl:apply-templates/>
                </FONT>
    ...
    <xsl:template match="responex">
        ...
        <!--
        <P>Apportez imm&#233;diatement les corrections n&#233;cessaires aux v&#233;hicules en stock. Tous les v&#233;hicules en stock faisant l&#8217;objet de la pr&#233;sente campagne doivent &#234;tre corrig&#233;s avant leur vente, leur transfert ou leur livraison. Si des v&#233;hicules ont &#233;t&#233; vendus ou transf&#233;r&#233;s et que vous avez re&#231;u des lettres d&#8217;avis au client et des cartes d&#8217;autorisation d&#8217;entretien de ces v&#233;hicules en vertu de ce rappel, vous devez aviser les &#233;tablissements o&#249; les v&#233;hicules ont &#233;t&#233; transf&#233;r&#233;s, ou le client, directement de votre &#233;tablissement de distributeur.</P>
        <P>Les &#233;tablissements d&#8217;exportation doivent pr&#233;senter les demandes de remboursement au titre de la garantie de la mani&#232;re habituelle en faisant r&#233;f&#233;rence au rappel de s&#233;curit&#233; G-01510.</P>
        <P>Nous comptons sur votre enti&#232;re collaboration et votre suivi concernant le pr&#233;sent rappel.  Si vous avez des questions ou si vous avez besoin d&#8217;aide, veuillez appeler le Directeur r&#233;gional de l&#8217;entretien au bureau r&#233;gional.</P>
        -->
        <xsl:apply-templates/>
    </xsl:template>
    ...
    <xsl:template match="responuscan">
        ...
        <!--
        <P>Apportez imm&#233;diatement les corrections n&#233;cessaires aux v&#233;hicules en stock. <b>Tous les v&#233;hicules en stock faisant l&#8217;objet de la pr&#233;sente campagne doivent &#234;tre corrig&#233;s avant leur vente, leur transfert ou leur livraison.</b> Si des v&#233;hicules ont &#233;t&#233; vendus ou transf&#233;r&#233;s et que vous avez re&#231;u des lettres d&#8217;avis au client et des cartes d&#8217;autorisation d&#8217;entretien de ces v&#233;hicules en vertu de ce rappel, vous devez aviser IMM&#201;DIATEMENT les &#233;tablissements o&#249; les v&#233;hicules ont &#233;t&#233; transf&#233;r&#233;s, ou le client, directement de votre &#233;tablissement concessionnaire.</P>
        <P>Les concessionnaires doivent corriger tous les v&#233;hicules vis&#233;s par ce programme sans aucuns frais aux propri&#233;taires, peu importe le kilom&#233;trage, l&#8217;&#226;ge du v&#233;hicule ou le propri&#233;taire, &#224; partir de maintenant.</P>
        <P>Cependant, comme l&#8217;indique l&#8217;avis au client, on s&#8217;attend &#224; ce que le concessionnaire effectue la r&#233;paration &#224; une date convenue mutuellement avec le client.</P>
        -->
        <xsl:apply-templates/>
    </xsl:template>
    ...
    <xsl:template match="defect">
        <xsl:element name="DIV">
            ...
            <!-- <xsl:attribute name="STYLE">width:520px;text-align:left;z-index:0;border:1px solid gray;</xsl:attribute> -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;DESCRIPTION DE
                    LA D&#201;FECTUOSIT&#201;
                </FONT>
                <BR/>
            </P>
    ...
    <xsl:template match="label">
        ...
        <xsl:element name="DIV">
            ...
            <!-- <xsl:attribute name="STYLE">width:520px;text-align:left;z-index:0;border:1px solid gray;</xsl:attribute> -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;&#201;TIQUETTE
                    D'IDENTIFICATION DE LA CAMPAGNE
                </FONT>
                <BR/>
            </P>
        </xsl:element>
    ...
    <xsl:template match="claims">
        <P STYLE="background-color:#EEEEEE;">
            <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;DEMANDES DE
                REMBOURSEMENT AU TITRE DE LA GARANTIE
            </FONT>
            <BR/>
        </P>
        <xsl:apply-templates/>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:if test="@graphiccount[.>'']">
                    ...
                    <!-- <P STYLE="background-color:black;"><FONT STYLE="font-weight:bold;font-size:12pt;color:#FFFFFF;background-color:black;">There are a lot of graphics in this procedure. Please wait for them to load. <xsl:value-of select="@graphiccount"/> graphics.</FONT><BR/></P> -->
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:apply-templates/>
