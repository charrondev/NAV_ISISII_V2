...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
    ...
    <xsl:template match="//isis">
        ...
        <xsl:element name="html">
            ...
            <BODY STYLE="margin-left:15px;font-family:arial;">
                <BR/>
                <xsl:apply-templates/>
                <BR/>
                <BR/>
                <P ALIGN="CENTER" STYLE="font-family:arial;">&#169; 2008 Navistar, Inc.</P>
                <BR/>
            </BODY>
    ...
    <xsl:template match="description">
        ...
        <xsl:element name="DIV">
            ...
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;DESCRIPCION
                </FONT>
                <BR/>
            </P>
            <xsl:apply-templates/>
    ...
    <xsl:template match="sstools">
        ...
        <xsl:element name="DIV">
            ...
            <!-- <xsl:attribute name="STYLE">width:520px;text-align:left;z-index:0;border:1px solid gray;</xsl:attribute> -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;HERRAMIENTAS
    ...
    <xsl:template match="torque">
        ...
        <xsl:element name="DIV">
            ...
            -->
            <P STYLE="background-color:#EEEEEE;">
                <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;TORSION</FONT>
                <BR/>
            </P>
            <xsl:apply-templates/>
        </xsl:element>
    ...
    <xsl:template match="entry//graphic">
        ...
        <xsl:if test="@type[.$ne$'jpeg']">
            ...
            <xsl:element name="OBJECT">
                ...
                <xsl:attribute name="CLASSID">clsid:F5D98C43-DB16-11CF-8ECA-0000C0FD59C7</xsl:attribute>
                <xsl:attribute name="CODEBASE">/service/downloads/Acgm.cab#Version=7,0,0,4</xsl:attribute>
                <xsl:element name="PARAM">
                    <xsl:attribute name="NAME">FileName</xsl:attribute>
    ...
    <xsl:template match="apply">
        ...
        <P STYLE="background-color:#EEEEEE;text-align:left">
            <FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;APLICAR
                <!-- <P STYLE="background-color:#EEEEEE;width:520px;text-align:left"><FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;">&#160;APLICAR -->
    ...
    <xsl:template match="ucodegroup">
        <BR/>C&#243;digo de la Unidad:
        <xsl:apply-templates/>
    </xsl:template>

    <xsl:template match="vendcodegroup">
        <BR/>C&#243;digo del Vendedor:
        <xsl:apply-templates/>
    </xsl:template>
    ...
    <xsl:template match="subject">
        ...
        <xsl:element name="DIV">
            ...
            <P STYLE="background-color:#EEEEEE;">
                ...
                <BR/>
                <!-- <P STYLE="background-color:#EEEEEE;"><FONT STYLE="font-weight:bold;font-size:12pt;color:black;background-color:#EEEEEE;width:520px;text-align:left">&#160;TEMA </FONT><BR/> -->
                <!--
                <xsl:value-of/>
                -->
                <xsl:apply-templates/>
